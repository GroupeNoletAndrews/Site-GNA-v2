            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-between p-6 pb-20 xs:pb-24 sm:p-10">
              ...
              <div className="flex flex-col items-center text-center gap-4">
                <img
                  ...
                  alt="Logo"
                  className="w-4/5 max-w-[200px] xs:max-w-[240px] sm:max-w-[300px] object-contain drop-shadow-sm opacity-95 mb-4"
                />
                <div className="h-px w-20 bg-white/40 mb-2" />
                <p className="text-white text-sm xs:text-base sm:text-lg font-light leading-snug max-w-xs sm:max-w-md drop-shadow-md">
                  {heroItem?.description}
                </p>
              </div>
              <div
                className="flex flex-col items-center gap-2 text-white/60 animate-bounce cursor-pointer"
                onClick={() => setMobileSection(1)}
              >
                <span className="text-[10px] xs:text-xs uppercase tracking-widest">
                  Découvrir
                </span>
                ...
                >
                  ...
                  {(introStage === "overlay-in" || introStage === "reveal") && (
                    ...
                    >
                      ...
                      <p className="mt-6 text-lg md:text-2xl text-slate-600 font-light leading-relaxed">
                        Naviguez les tuiles pour découvrir nos services <br />{" "}
                        et en apprendre plus sur nous.
                      </p>
                    </motion.div>
                  )}
                </motion.div>
